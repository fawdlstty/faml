...
作为大公司或顶级组织管理的项目，流行度和稳定性没的说，对于我来说，存在的最大问题是，难看。设计的都很近似json的组织形式，不如toml优雅，并且它们都有各自的语法特点，需要重新学习。学习本不是坏事，但对于配置这么小的场景来说，这笔心智负担得不偿失。于是我决定自己开发一个基于toml的动态配置语言。这就是faml的由来。
